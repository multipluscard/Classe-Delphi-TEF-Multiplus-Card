...
begin
   ...
   ConfigTEFMPL.Impressora.AvancoImpressora     := 5; // Deina quantas linhas é o avanço da impressora
   ...
   ConfigTEFMPL.Pagamento.TipoPgtoCartaoPIX  := tpMPlDebitoVista; // Informar qual tipo de cartão ou PIX vai transacionar, verifique quais os tipos disponíveis no arquivo uMultiplusTypes.pas
